...
function css() { return `:root{--bg:#0b1220;--panel:#101827;--panel2:#111c2f;--panel3:#0e1728;--line:#1e2a3d;--text:#f8fafc;--muted:#93a4bc;--blue:#2f6df6;--blue2:#1d4ed8;--green:#20c76a;--red:#ef4444;--red2:#b91c1c;--shadow:0 18px 60px rgba(0,0,0,.28)}*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}body:before{content:"";position:fixed;inset:0;background:linear-gradient(180deg,#111827 0,#0b1220 260px);pointer-events:none}.app-shell{position:relative;min-height:100vh;display:flex;flex-direction:column}.topbar{height:88px;border-bottom:1px solid var(--line);display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:24px;padding:0 max(28px,5vw);background:rgba(15,23,42,.86);backdrop-filter:blur(14px);position:sticky;top:0;z-index:10}.brand-mark{display:flex;align-items:center;min-width:0}.brand-mark strong{display:block;font-size:22px;line-height:1}.brand-mark span{display:block;margin-top:3px;color:var(--muted);font-size:13px}.nav-tabs{display:flex;align-items:center;gap:8px;background:#0a1020;border:1px solid var(--line);border-radius:14px;padding:6px}.tab{border:0;background:transparent;color:var(--muted);border-radius:10px;padding:12px 22px;font-weight:800;font-size:15px;cursor:pointer}.tab.active{background:var(--blue);color:white;box-shadow:0 10px 28px rgba(47,109,246,.28)}.top-actions{justify-self:end;display:flex;gap:12px;align-items:center}.primary,.ghost{border:0;border-radius:14px;padding:14px 20px;color:white;font-weight:800;font-size:15px;cursor:pointer;white-space:nowrap}.primary{background:var(--blue);box-shadow:0 12px 30px rgba(47,109,246,.25)}.primary:hover{background:var(--blue2)}.ghost{background:#364255;color:#fff}.ghost:hover{background:#46546a}.content{width:100%;max-width:1120px;margin:0 auto;padding:28px 22px 32px;flex:1}.section-head{display:flex;align-items:end;justify-content:space-between;gap:18px;margin:0 0 18px}.section-head h1{margin:0;font-size:30px;letter-spacing:0}.section-head p{margin:8px 0 0;color:var(--muted);font-size:15px}.summary-pill{border:1px solid var(--line);background:#0d1626;color:#dbeafe;border-radius:999px;padding:10px 14px;font-weight:800}.client-list{display:grid;gap:12px}.client-row{min-height:88px;background:var(--panel);border:1px solid #132036;border-radius:14px;box-shadow:0 10px 34px rgba(0,0,0,.18);display:grid;grid-template-columns:minmax(180px,1fr) 170px 78px;align-items:center;gap:18px;padding:18px 20px}.name{font-size:21px;font-weight:900;line-height:1.08;text-shadow:0 1px 0 rgba(0,0,0,.4);margin-bottom:7px}.sub{display:flex;gap:14px;align-items:center;color:#9bc9ff;font-size:16px}.sub span:not(.ip){color:var(--muted);font-size:14px}.ip{color:#9bc9ff}.status{color:var(--muted);font-size:13px}.status strong{display:block;color:var(--text);font-size:17px;font-weight:850;margin-bottom:5px}.status.allowed strong{color:var(--green)}.status.blocked strong{color:#ff6b6b}.avatar-wrap,.avatar,.dot{display:none}.switch{justify-self:end;position:relative;display:inline-block;width:68px;height:36px}.switch input{display:none}.slider{position:absolute;inset:0;border-radius:999px;background:#334155;transition:.18s;box-shadow:inset 0 0 0 1px rgba(255,255,255,.06)}.slider:before{content:"";position:absolute;width:28px;height:28px;right:4px;top:4px;background:white;border-radius:50%;transition:.18s;box-shadow:0 3px 12px rgba(0,0,0,.28)}.switch input:checked+.slider{background:var(--green)}.switch input:not(:checked)+.slider{background:var(--red2)}.switch input:not(:checked)+.slider:before{right:36px}.empty{padding:46px 24px;background:var(--panel);border:1px solid var(--line);border-radius:22px;color:var(--muted);text-align:center}.hidden{display:none}.settings{background:var(--panel3);border:1px solid var(--line);border-radius:16px;box-shadow:0 10px 34px rgba(0,0,0,.18);padding:24px}.settings-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.settings label{display:grid;gap:8px;color:#c7d2e2;font-size:13px;font-weight:800}.settings input{border:1px solid #263449;background:#0a1220;color:var(--text);border-radius:12px;padding:13px 14px;font:inherit;min-width:0}.settings input:focus{outline:2px solid rgba(47,109,246,.45);border-color:#3b82f6}.settings .check{display:flex;align-items:center;gap:10px;background:#0a1220;border:1px solid #263449;border-radius:12px;padding:13px 14px}.settings .check input{width:18px;height:18px}.wide{grid-column:1/-1}.save-btn{justify-self:start;margin-top:4px}.backup-panel{display:flex;align-items:center;gap:12px;margin-top:22px;flex-wrap:wrap}.backup-panel form{display:flex;gap:10px;align-items:center;flex-wrap:wrap}.backup-panel input[type=file]{color:var(--muted)}.footer{padding:20px;color:#7890bc;text-align:center;font-size:17px;border-top:1px solid rgba(30,42,61,.45);background:#0b1220}#toast{position:fixed;right:24px;bottom:24px;max-width:360px;padding:13px 15px;border-radius:12px;background:#e5e7eb;color:#0f172a;opacity:0;transform:translateY(10px);transition:.18s ease;font-weight:750;z-index:20}#toast.show{opacity:1;transform:translateY(0)}.login-shell{min-height:100vh;display:grid;place-items:center;padding:22px;background:linear-gradient(180deg,#111827,#0b1220)}.login-card{width:min(420px,calc(100vw - 32px));background:var(--panel);border:1px solid var(--line);border-radius:22px;padding:30px;box-shadow:var(--shadow)}.login-card h1{font-size:38px;margin:0 0 4px}.login-card p{color:var(--muted);margin:0 0 12px}.login-card input,.login-card button{width:100%;margin-top:14px}.login-card input{border:1px solid #263449;background:#0a1220;color:var(--text);border-radius:12px;padding:13px 14px;font:inherit}.login-card button{border:0;border-radius:14px;background:var(--blue);color:white;padding:13px 16px;font-weight:850;cursor:pointer}.alert{background:#451a1a;color:#fecaca;border-radius:12px;padding:10px 12px;margin-top:14px}@media(max-width:820px){body:before{display:none}.topbar{position:static;height:auto;grid-template-columns:1fr;padding:14px 16px}.nav-tabs{justify-self:stretch}.tab{flex:1}.top-actions{justify-self:stretch}.top-actions button{flex:1}.content{padding:22px 14px 28px}.section-head{align-items:flex-start;flex-direction:column}.client-row{grid-template-columns:1fr 68px;min-height:82px;padding:16px}.status{display:none}.switch{grid-column:2;grid-row:1}.settings{padding:16px}.settings-grid{grid-template-columns:1fr}.primary,.ghost{padding:12px 14px}.footer{font-size:15px;padding:16px}}`; }
