...
function renderRelay(){const relay=state.relay||{};if($('RELAY_TUNNEL'))$('RELAY_TUNNEL').checked=!!relay.tunnel_up;if($('RELAY_ROUTE'))$('RELAY_ROUTE').checked=!!relay.route_enabled;renderRelayConfig(relay);renderRelayStatus(relay)}
