...
async function handleApi(req, res) {
  ...
  if (req.method === "POST" && (pathname === "/api/v1/settings" || pathname === "/api/settings")) {
    const body = await jsonBody();
    const keys = ["PORTAL_IP","SERVER_PUBLIC_IP","RELAY_CLIENT_SUBNET","CAPTIVE_ALLOW_HOSTS","CAPTIVE_ALLOW_IPS","BLOCK_DNS","BLOCK_DOT","TELEGRAM_BOT_TOKEN","TELEGRAM_CHAT_ID","TELEGRAM_BACKUP_ENABLED","AUTO_BACKUP_ENABLED","AUTO_BACKUP_TIMES","EXPIRY_CHECK_TIMES","EXPIRY_CHECK_ENABLED","ADMIN_API_TOKEN"];
    const patch = {};
    ...
    const firewallKeys = ["PORTAL_IP","CAPTIVE_ALLOW_HOSTS","CAPTIVE_ALLOW_IPS","BLOCK_DNS","BLOCK_DOT"];
